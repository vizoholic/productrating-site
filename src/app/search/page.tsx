...
function VerdictBar({product,visible}:{product:AiProduct|null;visible:boolean}){
  ...
  return(
    <div style={{position:'fixed',top:56,left:0,right:0,zIndex:89,transform:visible?'translateY(0)':'translateY(-110%)',transition:'transform 0.4s cubic-bezier(0.22,1,0.36,1)',background:'rgba(255,255,255,0.97)',backdropFilter:'blur(20px)',borderBottom:'1px solid var(--border)',padding:'11px clamp(20px,5vw,40px)',display:'flex',alignItems:'center',gap:12,flexWrap:'nowrap',overflow:'hidden'}}>
...
function SearchResults(){
  ...
  return(
    <div style={{maxWidth:1040,margin:'0 auto',padding:'clamp(70px,8vw,84px) clamp(16px,4vw,24px) 100px'}}>
      ...
      {/* Sticky search */}
      <div style={{position:'sticky',top:56,zIndex:60,paddingTop:12,paddingBottom:12,background:'rgba(255,255,255,0.97)',backdropFilter:'blur(20px)'}}>
