...
export default async function ProductPage({ params }: { params: { slug: string } }) {
  ...
  // Google Structured Data — AggregateRating (shows stars in search results)
      ...
      <main style={{ paddingTop: 80, minHeight: '100vh' }}>
              ...
              <div>
                ...
                <div style={{ display: 'flex', alignItems: 'center', gap: 20, marginBottom: 24 }}>
                  ...
                  <div>
                    ...
                    <div style={{ display: 'inline-block', marginTop: 8, fontFamily: 'JetBrains Mono,monospace', fontSize: 10, letterSpacing: 1.5, textTransform: 'uppercase', padding: '5px 12px', borderRadius: 100, background: verdict.bg, border: `1px solid ${verdict.border}`, color: verdict.color }}>
                      {product.verdictBadge}
                    </div>
                  </div>
                </div>
        ...
        {reviews.length > 0 && (
          <section style={{ padding: '60px 48px' }}>
            <div style={{ maxWidth: 1000, margin: '0 auto' }}>
              <h2 style={{ fontFamily: 'Syne,sans-serif', fontSize: 28, fontWeight: 800, letterSpacing: '-1px', marginBottom: 32 }}>
                What Indian buyers say
              </h2>
